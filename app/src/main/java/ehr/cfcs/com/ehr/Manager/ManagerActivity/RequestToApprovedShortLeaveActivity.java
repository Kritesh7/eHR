...
public class RequestToApprovedShortLeaveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new ManagerRequestToApprovedShortLeaveAdapter(RequestToApprovedShortLeaveActivity.this,list,RequestToApprovedShortLeaveActivity.this);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for (int i=0 ; i<jsonArray.length();i++)
                    {
                        ...
                        list.add(new ManagerRequestToApprovedShortLeaveModel(LeaveApplication_Id,LeaveTypeName,StartDate,TimeFrom,TimeTo,AppliedDate,
